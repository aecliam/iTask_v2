			...
			<div class="card card-outline card-primary">
				...
				<div class="card-body">
					<ul class="users-list clearfix">
						...
						<a class="users-list-name"--> <a href="javascript:void(0)"><?php echo ucwords($row['name']) ?></a>
		...
		<div class="col-md-8">
			<div class="card card-outline card-primary">
				<div class="card-header">
					...
					<div class="card-tools">
						<a class="btn btn-primary bg-gradient-primary btn-sm" href="./index.php?page=new_task" type="button" id="new_task"><i class="fa fa-plus"></i> New Task</a>
					</div>
				<?php endif; ?>
				</div>
			...
			<div> <!--class="card"-->
				<div> <!--class="card-header"-->
					...
					<div> <!--class="card-tools"-->
						...
						<button type="button" id="new_productivity"><!--i class="fa fa-plus"></i--> New Productivity</button>
					</div>
				</div>
				<div> <!--class="card-body"-->
					<?php 
						...
						<div class="post">
		                      ...
		                      <div> <!--class="user-block"-->
								...
								<!-- class="btndropdown-toggle"-->
								  ...
								  <!--class="dropdown-item manage_progress"-->
								  	<a href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"  data-task="<?php echo $row['task'] ?>">Edit</a>
			                      	<div> <!--class="dropdown-divider"--></div>
									<!--class="dropdown-item delete_progress" -->
